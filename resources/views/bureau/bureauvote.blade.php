                    ...
                    @foreach ($lieuvotes as $lieuvote)
                            ...
                            <tr>
                                ...
                                <td>
                                  ...
                                  @if(Auth::user()->role=="prefet" || Auth::user()->role=="sous_prefet")  <a href="{{ route('lieuvote.bureau.create', ["id"=>$lieuvote->id,"commune"=> $lieuvote->centrevote->commune->id]) }}" role="button" class="btn btn-info"><i class="fas fa-user"></i></a>
